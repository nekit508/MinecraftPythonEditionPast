...
import pickle,os,sys,random,time,math
...
class Window(pyglet.window.Window):
    ...
    def save(self,args):
        if "save1" not in os.listdir("saves"):os.mkdir("saves/save1/")
        q1 = open("saves/save1/world.mcp","wb")
        q2 = open("saves/save1/shown.mcp", "wb")
        q3 = open("saves/save1/sectors.mcp", "wb")
    ...
    def load(self,args):
        q1 = open("saves/save1/world.mcp","rb")
        q2 = open("saves/save1/shown.mcp","rb")
        q3 = open("saves/save1/sectors.mcp","rb")
        d1 = q1.read()
        d2 = q2.read()
        d3 = q3.read()
        q1.close()
        ...
        for i in self.model.shown:
            ...
            self.model._shown[i] = self.model.batch.add(24, GL_QUADS, self.model.atlases[self.model.shown[i][1]][0],
                                                   ('v3f/static', vertex_data),
                                                   ('t2f/static', texture_data))
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Menes
        self.main_menu = [Button(self.width // 2, self.height // 2 + 60, 200, 30, "textures/ui/button2.png", "textures/ui/button1.png", "Load", "saves"),
                          Button(self.width // 2, self.height // 2 + 20, 200, 30, "textures/ui/button2.png", "textures/ui/button1.png", "Save", "save"),
                          Button(self.width // 2, self.height // 2 - 20, 200, 30, "textures/ui/button2.png", "textures/ui/button1.png", "Exit", "exit"),
                          Button(self.width // 2, self.height // 2 + 100, 200, 30, "textures/ui/button2.png", "textures/ui/button1.png", "Continue", "game"),
                         ]
        self.saves_menu = [Button(self.width // 2, self.height // 2 + 200, 200, 30, "textures/ui/button2.png", "textures/ui/button1.png", "Back", "main"),
                           Button(self.width // 2, self.height // 2 + 60, 200, 50, "textures/ui/button2.png","textures/ui/button1.png", "Load", "load")
                           ]
        ...
        # Menu's background
        self.bg = Sprite(image.load("textures/ui/background.png"),0,0)
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        if self.openMenu == True:
            for i in self.shown_menu:
                f = self.commands[i.type][0]
                a = self.commands[i.type][1]
                i.isHit(x, y, 1, f, a)
        elif self.exclusive:
